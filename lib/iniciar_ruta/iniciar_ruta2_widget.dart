...
import 'iniciar_ruta2_model.dart';
export 'iniciar_ruta2_model.dart';
...
class IniciarRuta2Widget extends StatefulWidget {
  const IniciarRuta2Widget({Key? key}) : super(key: key);

  @override
  _IniciarRuta2WidgetState createState() => _IniciarRuta2WidgetState();
}

class _IniciarRuta2WidgetState extends State<IniciarRuta2Widget> {
  int? selectedRadioValue;
  int _selectedIndex = 0;
  final GlobalKey<ScaffoldState> scaffoldKey;

  _IniciarRuta2WidgetState() : scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void initState() {
    ...
    _model = createModel(context, () => IniciarRuta2Model());
