...
import 'iniciar_ruta_lider3_model.dart';
export 'iniciar_ruta_lider3_model.dart';
...
class IniciarRuta3LiderWidget extends StatefulWidget {
  const IniciarRuta3LiderWidget({Key? key}) : super(key: key);

  @override
  _IniciarRuta3LiderWidgetState createState() =>
      _IniciarRuta3LiderWidgetState();
}

class _IniciarRuta3LiderWidgetState extends State<IniciarRuta3LiderWidget> {
  int? selectedRadioValue;
  int _selectedIndex = 0;
  final GlobalKey<ScaffoldState> scaffoldKey;

  _IniciarRuta3LiderWidgetState() : scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  late IniciarRuta3LiderModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => IniciarRuta3LiderModel());
                            ...
                            child: Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed('YaenRuta3Lider');
                                          },
                                          text: 'Si',
                                  ...
                                  Align(
                                    alignment: AlignmentDirectional(0.30, 0.1),
                                    child: Text(
