...
import 'iniciar_ruta_lider1_model.dart';
export 'iniciar_ruta_lider1_model.dart';
...
const LINE_COLOR = Color.fromARGB(255, 138, 137, 134);

// Configurar la imagen, ancho y alto predeterminados
const MARKER_SIZE_EXPANDED = 30.0;
const MARKER_SIZE_SHRINKED = 18.0;

class IniciarRuta1LiderWidget extends StatefulWidget {
  const IniciarRuta1LiderWidget({Key? key}) : super(key: key);

  @override
  _IniciarRuta1LiderWidgetState createState() =>
      _IniciarRuta1LiderWidgetState();
}

class _IniciarRuta1LiderWidgetState extends State<IniciarRuta1LiderWidget> {
  int? selectedRadioValue;
  int _selectedIndex = 0;
  final GlobalKey<ScaffoldState> scaffoldKey;
  late final AnimationController _animationController;

  _IniciarRuta1LiderWidgetState() : scaffoldKey = GlobalKey<ScaffoldState>();

  final _pageController = PageController();

  late latlong.LatLng mainPosition = latlong.LatLng(4.683488, -74.042486);
  late latlong.LatLng mainPositionCenter = latlong.LatLng(4.654400, -74.072959);
  late IniciarRuta1LiderModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => IniciarRuta1LiderModel());
                                  ...
                                  Align(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed('YaenRuta1Lider');
                                          },
                                          text: 'Si',
