            ...
            children: [
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(destinatario,
                        'El grupo de la ruta 3, Ha sufrido un daño en sus bicicletas!.');
              ...
              ConstrainedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(
                        destinatario, 'El grupo de la ruta 3, Ha sufrido un robo!.');
                    Navigator.of(context).pop();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF023047), // Fondo del botón
              ...
              ConstrainedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(destinatario,
                        'El grupo de la ruta 3, Ha sufrido un accidente!.');
                    Navigator.of(context).pop();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF023047), // Fondo del botón
