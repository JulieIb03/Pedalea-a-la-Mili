...
class YaenRuta1LiderWidget extends StatefulWidget {
  const YaenRuta1LiderWidget({Key? key}) : super(key: key);

  @override
  _YaenRuta1LiderWidgetState createState() => _YaenRuta1LiderWidgetState();
}

class _YaenRuta1LiderWidgetState extends State<YaenRuta1LiderWidget> {
  final GlobalKey<ScaffoldState> scaffoldKey;

  _YaenRuta1LiderWidgetState() : scaffoldKey = GlobalKey<ScaffoldState>();
            ...
            children: [
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(destinatario,
                        'El grupo de la ruta 1, Ha sufrido un daño en sus bicicletas!.');
              ...
              ConstrainedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(
                        destinatario, 'El grupo de la ruta 1, Ha sufrido un robo!.');
                    Navigator.of(context).pop();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF023047), // Fondo del botón
              ...
              ConstrainedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    enviarMensaje(destinatario,
                        'El grupo de la ruta 1, Ha sufrido un accidente!.');
                    Navigator.of(context).pop();
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF023047), // Fondo del botón
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        context.pushNamed('IntegrantesRuta1');
                                      },
                                      child: Container(
                                        height: 36.0,
