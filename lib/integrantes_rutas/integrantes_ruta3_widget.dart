...
class IntegrantesRuta3Widget extends StatefulWidget {
  const IntegrantesRuta3Widget({Key? key}) : super(key: key);

  @override
  _IntegrantesRuta3WidgetState createState() => _IntegrantesRuta3WidgetState();
}

class _IntegrantesRuta3WidgetState extends State<IntegrantesRuta3Widget> {
  final GlobalKey<ScaffoldState> scaffoldKey;

  _IntegrantesRuta3WidgetState() : scaffoldKey = GlobalKey<ScaffoldState>();
